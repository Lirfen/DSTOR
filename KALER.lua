...
JSON  = dofile("./dkjson.lua")URL = require('socket.url')  
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KALER.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KR", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KALER -X kill
screen -S KALER ./KALER
done
]])  
file:close() 
...
local KALER_Msg = ''  
if msgs < 100 then 
KALER_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KALER_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KALER_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KALER_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KALER_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KALER_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KALER_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KALER_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KALER_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
KALER_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KALER_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KALER_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
KALER_Msg = 'رب التفاعل💖'  
end 
return KALER_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKALER(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,KALER_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf KALER.lua')
os.execute('wget https://raw.githubusercontent.com/KALERTOGO/KALER/master/KALER.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..KALERk..''..KALER..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'KLERTEM')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KLERTEM')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
local KALER_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KALER_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..KALER_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/KLERTEM)}\n📛¦["..KALER_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/KLERTEM)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KLERTEM')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KLERTEM')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "KALER500k")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'KLERTEM')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'KLERTEM')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
time = times * 60
local function Restricted(Kara,KALER)
if tonumber(KALER.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(KALER.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(KALER.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(KALER.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,KALER.sender_user_id_,msg.date_+time)
local function name(kara,KALER)
if KALER.username_ == '' then name = KALER.first_name_ else name = KALER.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..KALER.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(KALER.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local KALER500K_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..KALER500K_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'KLERTEM')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..KALER_Msg[math.random(#KALER_Msg)]..']') 
return false
end
...
KALER = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KALER)
...
--------------------------------------------------------------------------------------------------------------
SourceKALER(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local KALERbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if KALERbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..KALERbot.."] \n") 
